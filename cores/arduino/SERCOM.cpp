...
void SERCOM::initSPI(SercomSpiTXPad mosi, SercomRXPad miso, SercomSpiCharSize charSize, SercomDataOrder dataOrder)
{
  ...
  //Setting the CTRLA register
  sercom->SPI.CTRLA.reg =	SERCOM_SPI_CTRLA_MODE(3) | // 0x2 :bus slave, 0x3 :bus master
...
/* Set GCLK_GEN0 as source for GCLK_ID_SERCOMx_CORE */
    ///* ----------------------------------------------------------------------------------------------
   //* Put Generic Clock Generator 0 as source for Generic Clock Multiplexer of specific sercom
   //*/
