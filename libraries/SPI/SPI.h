...
class SPIClassSAMR : public arduino::HardwareSPI {
  public:
  SPIClassSAMR(SERCOM *p_sercom, uint8_t uc_pinMISO, uint8_t uc_pinSCK, uint8_t uc_pinMOSI, SercomSpiTXPad, SercomRXPad);
